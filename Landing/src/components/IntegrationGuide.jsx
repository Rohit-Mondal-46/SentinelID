...
export default function IntegrationGuide({ onBack, onIntegrationClick, onDocsClick }) {
...
sentinel.onTransactionAttempt((transaction) => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      {/* Hero Section */}
      <section className="pt-36 pb-16 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
